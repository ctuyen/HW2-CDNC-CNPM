...
WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/span_'))

WebUI.setText(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/input_Name_newChannelName'), 
    'Development')

WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/span_Create Channel'))
