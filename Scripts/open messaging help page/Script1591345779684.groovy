...
WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/span_Help'))

WebUI.switchToWindowTitle('Mattermost')

WebUI.click(findTestObject('Object Repository/Page_Mattermost/span_Write messages using the text input bo_69ff14'))
