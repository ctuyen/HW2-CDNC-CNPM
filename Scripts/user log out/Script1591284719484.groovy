...
WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/button_sysadmin_style--none sidebar-header-_62345a'))

WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/span_Log Out'))
