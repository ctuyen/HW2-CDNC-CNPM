...
WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/button_sysadmin_CENTER_commentIcon_dxejt9ny_5657e3'))

WebUI.setText(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/textarea_Add a comment_reply_textbox'), 
    'reply')

WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/input_Help_addCommentButton'))
