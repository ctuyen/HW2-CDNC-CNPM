...
WebUI.click(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/path'))

WebUI.doubleClick(findTestObject('Object Repository/Page_ Town Square remane - eligendi Mattermost/path'))
