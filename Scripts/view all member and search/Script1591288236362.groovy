...
WebUI.click(findTestObject('Page_ Town Square - eligendi Mattermost/button_60'))

WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/span_View Members'))

WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/span_Next'))

WebUI.setText(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/input_Search users_searchUsersInput'), 
    'samuel.p')
