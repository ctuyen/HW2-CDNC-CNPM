...
WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/div_aaronmedina - Aaron Medina (Centidel) -_262370'))

WebUI.click(findTestObject('Object Repository/Page_ Town Square - eligendi Mattermost/button_Go'))

WebUI.setText(findTestObject('Page_ aaronmedina - eligendi Mattermost/textarea_Write to aaronmedina_post_textbox'), 'hi aaron.')
...
WebUI.setText(findTestObject('Page_ aaronmedina - eligendi Mattermost/textarea_Write to aaronmedina_post_textbox'), 'nice to meet you')
